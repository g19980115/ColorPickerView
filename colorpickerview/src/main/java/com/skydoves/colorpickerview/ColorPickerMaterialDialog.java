...
public class ColorPickerMaterialDialog extends AlertDialog {

    private ColorPickerView colorPickerView;

    public ColorPickerMaterialDialog(Context context) {
        super(context);
    }

    /**
     * Builder class for create {@link ColorPickerMaterialDialog}.
     */
    public static class Builder extends MaterialAlertDialogBuilder {
        ...
        /**
         * if true, attaches a {@link AlphaSlideBar} on the {@link ColorPickerMaterialDialog}.
         *
        ...
        /**
         * if true, attaches a {@link BrightnessSlideBar} on the {@link ColorPickerMaterialDialog}.
         *
         * @param value true or false.
         * @return {@link Builder}.
         */
        ...
        public Builder setBrightnessTip(CharSequence tip) {
            this.brightnessTip = tip;
            return this;
        }
        ...
        /**
         * sets positive button with {@link ColorPickerViewListener} on the {@link ColorPickerMaterialDialog}.
         *
        ...
        /**
         * shows a created {@link ColorPickerMaterialDialog}.
         *
        ...
        public AlertDialog create() {
            if (getColorPickerView() != null) {
                ...
                if (brightnessTip != null) {
                    this.dialogBinding.tvBrightnessTip.setText(brightnessTip);
                    this.dialogBinding.tvBrightnessTip.setVisibility(View.VISIBLE);
                } else {
                    this.dialogBinding.tvBrightnessTip.setVisibility(View.GONE);
                }
